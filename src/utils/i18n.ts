...
const i18n = new I18n({
  en: {
    ...
    setupLoading: {
      ...
      step2: 'Almost ready...',
      trackingTitle: 'Allow FormAI to track your activity across other companies\' apps and websites?',
      trackingDescription: 'This identifier will be used to deliver personalized ads to you.',
      askAppNotToTrack: 'Ask App Not to Track',
      allow: 'Allow',
    },
  },
  es: {
    ...
    setupLoading: {
      ...
      step2: 'Casi listo...',
      trackingTitle: '¿Permitir que FormAI rastree tu actividad en las aplicaciones y sitios web de otras empresas?',
      trackingDescription: 'Este identificador se utilizará para entregarte anuncios personalizados.',
      askAppNotToTrack: 'Pedir a la App que No Rastree',
      allow: 'Permitir',
    },
  },
  zh: {
    ...
    setupLoading: {
      ...
      step1: '正在设置您的个人资料...',
      step2: '快准备好了...',
      trackingTitle: '允许 FormAI 跟踪您在其他公司应用程序和网站上的活动？',
      trackingDescription: '此标识符将用于向您投放个性化广告。',
      askAppNotToTrack: '要求应用不跟踪',
      allow: '允许',
    },
  },
  it: {
    ...
    setupLoading: {
      ...
      step2: 'Quasi pronto...',
      trackingTitle: 'Consentire a FormAI di tracciare la tua attività su app e siti web di altre aziende?',
      trackingDescription: 'Questo identificatore verrà utilizzato per fornirti annunci personalizzati.',
      askAppNotToTrack: 'Chiedi all\'App di Non Tracciare',
      allow: 'Consenti',
    },
  },
  pt: {
    ...
    setupLoading: {
      ...
      step2: 'Quase pronto...',
      trackingTitle: 'Permitir que FormAI rastreie sua atividade em aplicativos e sites de outras empresas?',
      trackingDescription: 'Este identificador será usado para fornecer anúncios personalizados.',
      askAppNotToTrack: 'Pedir ao App para Não Rastrear',
      allow: 'Permitir',
    },
  },
  ro: {
    ...
    setupLoading: {
      ...
      step2: 'Aproape gata...',
      trackingTitle: 'Permiteți FormAI să vă urmărească activitatea pe aplicațiile și site-urile web ale altor companii?',
      trackingDescription: 'Acest identificator va fi folosit pentru a vă livra anunțuri personalizate.',
      askAppNotToTrack: 'Cereți Aplicației să Nu Urmărească',
      allow: 'Permite',
    },
  },
  de: {
    ...
    setupLoading: {
      ...
      step2: 'Fast fertig...',
      trackingTitle: 'FormAI erlauben, Ihre Aktivität in Apps und Websites anderer Unternehmen zu verfolgen?',
      trackingDescription: 'Dieser Bezeichner wird verwendet, um Ihnen personalisierte Anzeigen zu liefern.',
      askAppNotToTrack: 'App Bitten Nicht Zu Verfolgen',
      allow: 'Erlauben',
    },
  },
  fr: {
    ...
    setupLoading: {
      ...
      step2: 'Presque prêt...',
      trackingTitle: 'Autoriser FormAI à suivre votre activité sur les applications et sites web d\'autres entreprises ?',
      trackingDescription: 'Cet identifiant sera utilisé pour vous fournir des publicités personnalisées.',
      askAppNotToTrack: 'Demander à l\'App de Ne Pas Suivre',
      allow: 'Autoriser',
    },
  },
  ar: {
    ...
    setupLoading: {
      ...
      step2: 'تقريباً جاهز...',
      trackingTitle: 'السماح لـ FormAI بتتبع نشاطك عبر تطبيقات ومواقع الشركات الأخرى؟',
      trackingDescription: 'سيتم استخدام هذا المعرف لتقديم إعلانات مخصصة لك.',
      askAppNotToTrack: 'اطلب من التطبيق عدم التتبع',
      allow: 'السماح',
    },
  },
});
