const en = {
    ...
    onboarding: {
      ...
      cameraPermission: {
        ...
        permissionRequiredMessage: 'Camera access is required to continue. You can enable it in Settings.',
        accessRequired: 'Camera Access Required',
        accessRequiredMessage: 'We need camera access to record your workout videos for form analysis. Please grant camera access in Settings to continue.',
    ...
    upload: {
      ...
      deniedAccessMessage: 'We can see you have denied access. However, we require full access to your photo library to provide you with all the features in our app for video management. This includes duplicate detection, video search, robust video organization, and seamless video selection across your entire library.',
      limitedAccessMessage: 'We can see you have allowed limited access. However, we require full access to your photo library to provide you with all the features in our app for video management. This includes duplicate detection, video search, robust video organization, and seamless video selection across your entire library.',
      fullAccessMessage: 'We require full access to your photo library to provide you with all the features in our app for video management. This includes duplicate detection, video search, robust video organization, and seamless video selection across your entire library.',
      grant: 'Grant',
      openSettings: 'Open Settings',
      uploadVideo: 'Upload Video',
      selectNewVideo: 'New Video',
