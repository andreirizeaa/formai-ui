const zh = {
    ...
    onboarding: {
      ...
      cameraPermission: {
        ...
        accessRequiredMessage: '我们需要摄像头访问权限来录制您的训练视频以进行姿势分析。请在设置中授予摄像头访问权限以继续。',
        openSettings: '打开设置',
      },
    ...
    upload: {
      ...
      deniedAccessMessage: '我们可以看到您已拒绝访问。但是，我们需要完全访问您的照片库才能为您提供应用程序中视频管理的所有功能。这包括重复检测、视频搜索、强大的视频组织以及在整个库中无缝的视频选择。',
      limitedAccessMessage: '我们可以看到您已允许有限访问。但是，我们需要完全访问您的照片库才能为您提供应用程序中视频管理的所有功能。这包括重复检测、视频搜索、强大的视频组织以及在整个库中无缝的视频选择。',
      fullAccessMessage: '我们需要完全访问您的照片库，以便为您提供我们应用程序中所有视频管理功能。这包括重复检测、视频搜索、强大的视频组织以及在整个库中无缝选择视频。',
      grant: '授权',
      openSettings: '打开设置',
      uploadVideo: '上传视频',
      selectNewVideo: '新视频',
