const de = {
  ...
  'emailAuth': {
    ...
    'codeInstructions':
      'Bitte gib den 6-stelligen Code ein, den wir gerade an {{email}} gesendet haben',
    'resend': 'Erneut senden',
    'resendIn': 'Du kannst in {{seconds}} Sekunden erneut senden',
  ...
  'settings': {
    ...
    'deleteAccountMessage':
      'Möchtest du dein Konto dauerhaft löschen? Dieser Vorgang kann nicht rückgängig gemacht werden und alle Daten werden gelöscht.',
    'deleteAccountSubscriptionWarning':
      'Das Löschen deines Form-AI-Kontos in der App beendet dein Abonnement nicht. Denke daran, es in den Abo-Einstellungen deines Geräts separat zu kündigen, damit keine weiteren Kosten anfallen.',
    'iAcknowledge': 'Ich bestätige',
    'deleteAccountButton': 'Konto löschen',
    'logoutTitle': 'Abmelden?',
    'logoutMessage':
      'Möchtest du dich wirklich abmelden? Du musst dich anschließend erneut anmelden.',
    'no': 'Nein',
    'yes': 'Ja',
    'editFailed': {
  ...
  'add': {
    ...
    'uploadVideoDescription':
      'Wähle ein Video aus deiner Galerie, um deine Technik zu analysieren.',
  ...
  'welcome': {
    ...
    'modal': {
      'title': 'Willkommen',
      'message':
        'Danke für dein Vertrauen in Form AI. Wir freuen uns, dir beim Erreichen deiner Ziele zu helfen.',
  ...
  'onboarding': {
    'incompleteAccount': {
      ...
      'message':
        'Deine Kontoeinrichtung ist noch nicht abgeschlossen. Bitte schließe das Onboarding ab, um fortzufahren.',
    },
    'language': {
      'title': 'Sprache',
    ...
    'cameraPermission': {
      ...
      'permissionRequiredMessage':
        'Kamerazugriff ist erforderlich, um fortzufahren. Sie können ihn in den Einstellungen aktivieren.',
    },
    'mediaLibraryPermission': {
      ...
      'permissionRequiredMessage':
        'Fotozugriff ist erforderlich, um fortzufahren. Sie können ihn in den Einstellungen aktivieren.',
      'openSettings': 'Einstellungen öffnen',
      'tryAgain': 'Erneut versuchen',
      'error': 'Berechtigungsfehler',
      'errorMessage':
        'Fotobibliothek-Berechtigungen konnten nicht angefordert werden. Du kannst sie später in den Einstellungen aktivieren.',
    },
    'perfectFormGoalMessage': {
      ...
      'subtitle':
        '95 % der Nutzer sagen, dass die Veränderung nach der Nutzung von Form AI deutlich ist.',
    },
    'potentialGraph': {
      'title': 'Du hast enormes Potenzial, dein Ziel zu erreichen',
      'chartTitle': 'Dein Präzisionsverlauf',
      'subtitle':
        'Basierend auf historischen Daten verbessert sich die Präzision anfangs langsamer – nach 14 Tagen wirst du sehr konstant!',
      'dayLabels': {
        'day3': '3 Tage',
        'day14': '14 Tage',
        'day30': '30 Tage',
  ...
  'performance': {
    ...
    'info': {
      'accuracyPerWeight': {
        ...
        'message':
          'Zeigt die durchschnittliche Formpräzision für jedes gehobene Gewicht einer Bewegung. Höhere Gewichte fordern die Technik. Berechnung: Mittelwert der Präzisionswerte je Gewicht.',
      },
      'accuracyOverTime': {
        'title': 'Präzision im Zeitverlauf',
        'message':
          'Zeigt, wie sich deine Formpräzision über die Zeit für eine Bewegung verändert. Durchschnitt pro Tag, über die Daten hinweg dargestellt.',
      },
      'accuracy': {
        'title': 'Präzision',
        'message':
          'Deine durchschnittliche Präzision über die gesamte Zeit. Mittelwert aller Präzisionswerte.',
      },
      'improvement': {
        'title': 'Trend',
        'message':
          'Zeigt deinen Fortschritt über alle Lift-Typen. Für jeden Übungstyp vergleichen wir deine erste Leistung mit deiner neuesten Leistung und berechnen die prozentuale Änderung relativ zum verfügbaren Verbesserungsraum. Werte reichen von -100% (Rückgang) bis +100% (Verbesserung), dann Durchschnitt über alle Übungstypen.',
      },
      'videos': {
        'title': 'Videos',
        'message':
          'Gesamtanzahl der Trainingsvideos, die du aufgenommen und analysiert hast. Jedes Video stellt eine komplette Serie von Wiederholungen für eine bestimmte Übung dar.',
      },
      'reps': {
        'title': 'Wiederholungen',
        'message':
          'Gesamtanzahl der Wiederholungen, die du in allen deinen aufgezeichneten Workouts ausgeführt hast. Das umfasst jede Wiederholung jeder Serie, die du abgeschlossen hast.',
      },
      'totalWeight': {
        'title': 'Gesamtgewicht bewegt',
        'message':
          'Das kumulative Gewicht, das du in allen deinen Workouts bewegt hast. Berechnet durch Multiplikation des verwendeten Gewichts mit der Anzahl der Wiederholungen für jede Serie, dann Summierung aller Serien.',
      },
    },
    'noData': 'Keine Daten',
    ...
    'startAnalyzingWorkout':
      'Beginne mit der Analyse des heutigen Trainings durch ein kurzes Video',
  ...
  'library': {
    ...
    'searchAnalysis': {
      ...
      'noAnalysisFoundMessage':
        'Keine Analyse für dieses Video. Bitte stelle sicher, dass es analysiert wurde.',
      'analyse': 'Analysieren',
      'permissionRequired': 'Berechtigung erforderlich',
      'permissionMessage':
        'Bitte erlaube den Zugriff auf deine Fotomediathek, um Videos zu suchen.',
      'error': 'Fehler',
    ...
    'photoLibraryPermission': {
      ...
      'message':
        'Vollzugriff auf die Fotomediathek ist erforderlich, um nach zuvor analysierten Videos zu suchen. Beachte, dass die Suche nur für Videos funktioniert, die nach der Gewährung des Vollzugriffs analysiert wurden.',
      'allow': 'Erlauben',
      'cancel': 'Abbrechen',
    },
  },
  ...
  'feedback': {
    ...
    'deleteLiftMessage':
      'Möchtest du diesen Lift wirklich löschen? Das kann nicht rückgängig gemacht werden.',
    'cancel': 'Abbrechen',
    'delete': 'Löschen',
    'howItWorks': 'So funktioniert’s',
    'viewFeedback': 'Feedback anzeigen',
    'step1':
      'Unsere KI erkennt bestimmte Momente in deinem Lift, in denen du die Form verbessern kannst.',
  ...
  'tutorial': {
    ...
    'addOptionsUpload': {
      ...
      'description':
        'Hier kannst du ein Video importieren oder ein neues in der App aufnehmen – es wird auch in deiner Fotomediathek gespeichert.\n\nFür diese Tour importieren wir ein Demovideo.',
    },
    'uploadPracticesCta': {
      'title': 'Tipps & Upload',
      'description':
        'Hier findest du allgemeine Hinweise zur Videoqualität und wie du die besten Ergebnisse erzielst.\n\nDer nächste Schritt würde deine Mediathek öffnen, wird für die Demo aber übersprungen.',
    },
    ...
    'weightRepsInfo': {
      'weight': {
        'title': 'Gewicht',
        'message':
          'Gib das Gewicht ein, das du gehoben hast, um deinen Fortschritt im Fortschrittsbildschirm zu verfolgen. Bitte sei genau. Du kannst das später ändern.',
      },
      'reps': {
        'title': 'Wiederholungen',
        'message':
          'Gib die exakte Anzahl der Wiederholungen ein, die du ausgeführt hast. Die Analyse wird nur die spezifische Anzahl der eingegebenen Wiederholungen bewerten, und das kann später nicht geändert werden.',
      },
    },
    'homeFirstLiftCard': {
      'title': 'Tippe hier, um deine Analyse zu sehen',
      'description':
        'Dein Lift erscheint hier mit Analyse. Tippe für Details oder wische zum Löschen.',
    },
    ...
    'libraryScreen': {
      ...
      'description':
        'Deine gesamte Lift-Bibliothek. Wechsle zwischen Alle und Favoriten. Sortiere, filtere und suche!\n\nTippe für Details, wische zum Löschen.',
    },
    'homePerformanceIcon': {
  ...
  'upload': {
    ...
    'mediaPermissionDetailedDescription':
      'Form AI greift auf deine Fotobibliothek zu, damit du Videos für die Analyse hochladen, in der App aufgenommene Videos in deiner Fotobibliothek speichern, zuvor analysierte Videos suchen und doppelte Video-Uploads verhindern kannst.',
    'allow': 'Zulassen',
    'dontAllow': 'Nicht zulassen',
    'videoTooLong': 'Video zu lang',
    'videoTooLongMessage': 'Bitte wähle ein Video unter 90 Sekunden.',
    'videoTooShort': 'Video zu kurz',
    'videoTooShortMessage': 'Bitte stelle sicher, dass das Video mindestens 2 Sekunden lang ist.',
    'error': 'Fehler',
    'failedToSelectVideo': 'Videoauswahl fehlgeschlagen. Bitte erneut versuchen.',
    'failedToGenerateThumbnail':
      'Miniaturbild konnte nicht erstellt werden. Bitte erneut versuchen.',
    ...
    'deniedAccessMessage':
      'Wir können sehen, dass Sie den Zugriff verweigert haben. Wir benötigen jedoch vollen Zugriff auf Ihre Fotobibliothek, um Ihnen alle Funktionen unserer App für die Videoverwaltung zu bieten. Dazu gehören Duplikaterkennung, Videosuche, robuste Videoorganisation und nahtlose Videowahl in Ihrer gesamten Bibliothek.',
    'limitedAccessMessage':
      'Wir können sehen, dass Sie eingeschränkten Zugriff gewährt haben. Wir benötigen jedoch vollen Zugriff auf Ihre Fotobibliothek, um Ihnen alle Funktionen unserer App für die Videoverwaltung zu bieten. Dazu gehören Duplikaterkennung, Videosuche, robuste Videoorganisation und nahtlose Videowahl in Ihrer gesamten Bibliothek.',
    'fullAccessMessage':
      'Wir benötigen vollen Zugriff auf Ihre Fotobibliothek, um Ihnen alle Funktionen unserer App für die Videoverwaltung zu bieten. Dazu gehören Duplikaterkennung, Videosuche, robuste Videoorganisation und nahtlose Videowahl in Ihrer gesamten Bibliothek.',
    'grant': 'Gewähren',
    'uploadVideo': 'Video hochladen',
    'selectNewVideo': 'Neues Video',
    ...
    'duplicateVideoProcessingMessage':
      'Dieses Video wird gerade verarbeitet. Bitte wähle ein anderes.',
