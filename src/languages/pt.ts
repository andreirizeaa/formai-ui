const pt = {
    ...
    onboarding: {
      incompleteAccount: {
        ...
        message: 'A configuração da sua conta ainda não está completa. Conclua o onboarding para continuar.',
      },
      language: {
        title: 'Idioma',
      ...
      cameraPermission: {
        ...
        accessRequiredMessage: 'Precisamos de acesso à câmera para gravar seus vídeos de treino para análise de forma. Por favor, conceda acesso à câmera nas Configurações para continuar.',
      ...
      mediaLibraryPermission: {
        ...
        errorMessage: 'Não foi possível solicitar permissões da biblioteca de fotos. Você pode habilitá-las mais tarde nas configurações.',
      },
    ...
    tutorial: {
      ...
      weightRepsInfo: {
        weight: {
          title: 'Peso',
          message: 'Digite o peso que você levantou para acompanhar seu progresso ao longo do tempo na tela de progresso. Seja preciso. Você pode alterar isso mais tarde.',
        },
        reps: {
          title: 'Repetições',
          message: 'Digite o número exato de repetições que você realizou. A análise avaliará apenas o número específico de repetições que você inserir, e isso não pode ser alterado mais tarde.',
        },
      },
      homeFirstLiftCard: {
    ...
    upload: {
      ...
      deniedAccessMessage: 'Podemos ver que você negou o acesso. No entanto, precisamos de acesso completo à sua biblioteca de fotos para fornecer todos os recursos em nosso aplicativo para gerenciamento de vídeos. Isso inclui detecção de duplicatas, busca de vídeos, organização robusta de vídeos e seleção perfeita de vídeos em toda sua biblioteca.',
      limitedAccessMessage: 'Podemos ver que você permitiu acesso limitado. No entanto, precisamos de acesso completo à sua biblioteca de fotos para fornecer todos os recursos em nosso aplicativo para gerenciamento de vídeos. Isso inclui detecção de duplicatas, busca de vídeos, organização robusta de vídeos e seleção perfeita de vídeos em toda sua biblioteca.',
      fullAccessMessage: 'Precisamos de acesso completo à sua biblioteca de fotos para fornecer todos os recursos do nosso aplicativo para gerenciamento de vídeos. Isso inclui detecção de duplicatas, busca de vídeos, organização robusta de vídeos e seleção perfeita de vídeos em toda a sua biblioteca.',
      grant: 'Conceder',
      openSettings: 'Abrir Configurações',
      uploadVideo: 'Enviar Vídeo',
      selectNewVideo: 'Novo Vídeo',
      ...
      duplicateVideoProcessingMessage: 'Este vídeo está sendo processado atualmente. Por favor selecione um vídeo diferente.',
