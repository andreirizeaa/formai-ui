const ar = {
  ...
  'emailAuth': {
    ...
    'confirmTitle': 'قم بتأكيد بريدك الإلكتروني',
    'codeInstructions': 'يرجى إدخال الرمز المكون من 6 أرقام الذي أرسلناه للتو إلى {{email}}',
    'resend': 'إعادة الإرسال',
    'resendIn': 'يمكنك إعادة الإرسال خلال {{seconds}} ثانية',
    'invalidCode': 'الرمز الذي أدخلته غير صالح. يرجى المحاولة مرة أخرى.',
  },
  'password': 'كلمة المرور',
  'passwordInvalid': 'يجب أن تحتوي كلمة المرور على 9+ أحرف، وتشمل حرفًا كبيرًا ورقمًا ورمزًا.',
  'incorrectEmailOrPassword': 'البريد الإلكتروني أو كلمة المرور غير صحيحة.',
  'passwordRequirements': {
    'minLength': '9 أحرف على الأقل',
