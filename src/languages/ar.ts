const ar = {
    ...
    "performance": {
      ...
      "info": {
        ...
        "improvement": {
          "title": "التحسن",
          "message": "كيف تغير أداؤك عبر كل الأوقات. نقارن الثلث الأول من رفعاتك بالثلث الأخير ونُظهر الفرق في متوسط الدقة."
        }
      },
      "metricsFeedback": {
    ...
    "upload": {
      ...
      "fullAccessRequired": "الوصول الكامل لمكتبة الصور",
      "fullAccessMessage": "نحتاج إلى وصول كامل لمكتبة الصور الخاصة بك لتوفير جميع ميزات التطبيق لإدارة الفيديوهات. يشمل ذلك اكتشاف التكرارات والتنظيم المناسب للفيديوهات والاختيار السلس للفيديوهات عبر مكتبتك بالكامل.",
      "grant": "منح",
      "uploadVideo": "رفع فيديو",
      "selectNewVideo": "فيديو جديد",
