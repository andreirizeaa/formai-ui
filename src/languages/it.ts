const it = {
    ...
    onboarding: {
      ...
      cameraPermission: {
        ...
        accessRequiredMessage: 'Abbiamo bisogno dell\'accesso alla fotocamera per registrare i tuoi video di allenamento per l\'analisi della forma. Per favore, concedi l\'accesso alla fotocamera nelle Impostazioni per continuare.',
    ...
    upload: {
      ...
      deniedAccessMessage: 'Possiamo vedere che hai negato l\'accesso. Tuttavia, richiediamo accesso completo alla tua libreria foto per fornirti tutte le funzionalità nella nostra app per la gestione dei video. Questo include rilevamento duplicati, ricerca video, organizzazione robusta dei video e selezione perfetta dei video in tutta la tua libreria.',
      limitedAccessMessage: 'Possiamo vedere che hai consentito accesso limitato. Tuttavia, richiediamo accesso completo alla tua libreria foto per fornirti tutte le funzionalità nella nostra app per la gestione dei video. Questo include rilevamento duplicati, ricerca video, organizzazione robusta dei video e selezione perfetta dei video in tutta la tua libreria.',
      fullAccessMessage: 'Abbiamo bisogno dell\'accesso completo alla tua libreria foto per fornirti tutte le funzionalità della nostra app per la gestione video. Questo include rilevamento duplicati, ricerca video, organizzazione robusta dei video e selezione fluida dei video in tutta la tua libreria.',
      grant: 'Concedi',
      openSettings: 'Apri Impostazioni',
      uploadVideo: 'Carica Video',
      selectNewVideo: 'Nuovo Video',
