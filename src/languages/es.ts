const es = {
    ...
    onboarding: {
      incompleteAccount: {
        ...
        message: 'La configuración de tu cuenta aún no está completa. Por favor, completa el onboarding para continuar.',
      },
      language: {
        title: 'Idioma',
      ...
      cameraPermission: {
        ...
        permissionRequiredMessage: 'Se requiere acceso a la cámara para continuar. Puedes habilitarlo en Configuración.',
        accessRequired: 'Acceso a la Cámara Requerido',
        accessRequiredMessage: 'Necesitamos acceso a la cámara para grabar tus videos de entrenamiento para análisis de forma. Por favor, concede acceso a la cámara en Configuración para continuar.',
    ...
    tutorial: {
      ...
      completionModal: {
        title: 'Todo listo',
        message: 'Estás listo para usar Form AI. Revisa cada día para mantener tu racha viva y mantenerte consistente. \\n\\nRecuerda que siempre puedes repetir este tutorial en cualquier momento a través del menú de configuración.',
      },
    },
    upload: {
      permissionRequired: 'Permiso Requerido',
      ...
      deniedAccessMessage: 'Podemos ver que has denegado el acceso. Sin embargo, requerimos acceso completo a tu biblioteca de fotos para brindarte todas las funciones en nuestra aplicación para la gestión de videos. Esto incluye detección de duplicados, búsqueda de videos, organización robusta de videos y selección perfecta de videos en toda tu biblioteca.',
      limitedAccessMessage: 'Podemos ver que has permitido acceso limitado. Sin embargo, requerimos acceso completo a tu biblioteca de fotos para brindarte todas las funciones en nuestra aplicación para la gestión de videos. Esto incluye detección de duplicados, búsqueda de videos, organización robusta de videos y selección perfecta de videos en toda tu biblioteca.',
      fullAccessMessage: 'Necesitamos acceso completo a tu biblioteca de fotos para brindarte todas las funciones de nuestra aplicación para la gestión de videos. Esto incluye detección de duplicados, búsqueda de videos, organización robusta de videos y selección fluida de videos en toda tu biblioteca.',
      grant: 'Conceder',
      openSettings: 'Abrir Configuración',
      uploadVideo: 'Subir Video',
      selectNewVideo: 'Nuevo Video',
