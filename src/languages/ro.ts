const ro = {
  ...
  'password': 'Parolă',
  'passwordInvalid': 'Parola trebuie să aibă 9+ caractere, să includă majusculă, număr și simbol.',
  'incorrectEmailOrPassword': 'E-mail sau parolă incorectă.',
  'passwordRequirements': {
    'minLength': 'Cel puțin 9 caractere',
  ...
  'settings': {
    ...
    'deleteAccountMessage':
      'Ești sigur că vrei să ștergi definitiv contul? Această acțiune nu poate fi anulată și toate datele vor fi șterse.',
    'deleteAccountSubscriptionWarning':
      'Ștergerea contului Form AI din aplicație nu anulează abonamentul. Nu uita să-l anulezi separat din setările de abonamente ale dispozitivului pentru a evita costuri ulterioare.',
    'iAcknowledge': 'Confirm',
    'deleteAccountButton': 'Șterge contul',
    'logoutTitle': 'Te deconectezi?',
    'logoutMessage':
      'Sigur vrei să te deconectezi? Va trebui să te autentifici din nou pentru a accesa contul.',
    'no': 'Nu',
    'yes': 'Da',
    'editFailed': {
  ...
  'add': {
    ...
    'recordVideoDescription':
      'Înregistrează un video nou pentru a-ți analiza tehnica exercițiului.',
  ...
  'welcome': {
    ...
    'modal': {
      'title': 'Bun venit',
      'message':
        'Îți mulțumim pentru încrederea acordată Form AI. Suntem încântați să te ajutăm să-ți atingi obiectivele.',
  ...
  'onboarding': {
    'incompleteAccount': {
      ...
      'message':
        'Configurarea contului tău nu este încă finalizată. Te rugăm să finalizezi onboarding-ul pentru a continua.',
    },
    'language': {
      'title': 'Limbă',
    ...
    'cameraPermission': {
      ...
      'permissionRequiredMessage':
        'Accesul la cameră este necesar pentru a continua. Îl poți activa în Setări.',
    },
    'mediaLibraryPermission': {
      ...
      'permissionRequiredMessage':
        'Accesul la foto este necesar pentru a continua. Îl poți activa în Setări.',
      'openSettings': 'Deschide Setările',
      'tryAgain': 'Încearcă Din Nou',
      'error': 'Eroare de Permisiune',
      'errorMessage':
        'Nu s-a putut solicita permisiunea pentru biblioteca de fotos. O poți activa mai târziu în setări.',
    },
    'perfectFormGoalMessage': {
      ...
      'subtitle':
        '95% dintre utilizatori spun că schimbarea este vizibilă după utilizarea Form AI.',
    },
    'potentialGraph': {
      'title': 'Ai un potențial uimitor să-ți atingi obiectivul',
      'chartTitle': 'Tranziția preciziei tale',
      'subtitle':
        'Bazat pe datele istorice Form AI, îmbunătățirea este întârziată la început, dar după 14 zile devii foarte constant!',
      'dayLabels': {
        'day3': '3 Zile',
        'day14': '14 Zile',
        'day30': '30 Zile',
    ...
    'gymChallengeInfo': {
      ...
      'unsureForm': {
        ...
        'message':
          'Îți oferim feedback clar ca să te antrenezi sigur și eficient, de fiecare dată.',
        'howWeGetYouThere': [
  ...
  'performance': {
    ...
    'info': {
      'accuracyPerWeight': {
        ...
        'message':
          'Arată precizia medie a formei pentru fiecare greutate ridicată la o mișcare. Greutățile mari pot pune forma la încercare. Calcul: media scorurilor pentru fiecare greutate.',
      },
      'accuracyOverTime': {
        'title': 'Precizie în timp',
        'message':
          'Arată cum se schimbă precizia formei în timp pentru o mișcare. Media zilnică este reprezentată pe parcursul datelor.',
      },
      'accuracy': {
        'title': 'Precizie',
      ...
      'improvement': {
        'title': 'Tendință',
        'message':
          'Arată progresul tău prin toate tipurile de lifturi. Pentru fiecare tip de exercițiu, comparăm prima ta performanță cu cea mai recentă și calculăm schimbarea procentuală relativă la spațiul de îmbunătățire disponibil. Valorile merg de la -100% (declin) la +100% (îmbunătățire), apoi media pe toate tipurile de exercițiu.',
      },
      'videos': {
        'title': 'Videoclipuri',
        'message':
          'Numărul total de videoclipuri de antrenament pe care le-ai înregistrat și analizat. Fiecare videoclip reprezintă o serie completă de repetiții pentru un exercițiu specific.',
      },
      'reps': {
        'title': 'Repetiții',
        'message':
          'Numărul total de repetiții efectuate în toate antrenamentele tale înregistrate. Aceasta include fiecare repetiție din fiecare serie pe care ai completat-o.',
      },
      'totalWeight': {
        'title': 'Greutate totală ridicată',
        'message':
          'Greutatea cumulativă pe care ai ridicat-o în toate antrenamentele tale. Calculată prin înmulțirea greutății folosite cu numărul de repetiții pentru fiecare serie, apoi însumarea tuturor seriilor.',
      },
    },
    'noData': 'Fără date',
  ...
  'library': {
    ...
    'searchAnalysis': {
      ...
      'noAnalysisFoundMessage':
        'Nu există analiză pentru acest video. Asigură-te că a fost analizat.',
      'analyse': 'Analizează',
    ...
    'photoLibraryPermission': {
      ...
      'message':
        'Accesul complet la biblioteca foto este necesar pentru a vă permite să căutați videoclipuri analizate anterior. Vă rugăm să rețineți că căutarea va funcționa doar pentru videoclipurile analizate după acordarea accesului complet la biblioteca foto.',
      'allow': 'Permite',
      'cancel': 'Anulează',
    },
  },
  ...
  'feedback': {
    ...
    'step1':
      'AI-ul nostru observă momente specifice în timpul liftului în care forma poate fi îmbunătățită.',
  ...
  'tutorial': {
    ...
    'addOptionsUpload': {
      ...
      'description':
        'Aici poți încărca un video sau înregistra unul nou în aplicație, care va fi salvat și în galeria foto.\n\nPentru acest tur vom încărca un video demo.',
    },
    'uploadPracticesCta': {
      'title': 'Sfaturi & încărcare',
      'description':
        'Găsești aici recomandări privind calitatea video și cum obții cele mai bune rezultate.\n\nPasul următor ar deschide galeria, dar îl omitem în demo.',
    },
    ...
    'movementSelectionContinue': {
      ...
      'description':
        'Selectează o mișcare exactă pentru a ne ajuta să analizăm corect forma.\n\nDacă nu o găsești, scrie echipei de suport și vom încerca să o adăugăm.',
    },
    'weightRepsComplete': {
    ...
    'weightRepsInfo': {
      'weight': {
        'title': 'Greutate',
        'message':
          'Introdu greutatea pe care ai ridicat-o pentru a-ți urmări progresul în timp pe ecranul de progres. Te rog să fii precis. Poți schimba asta mai târziu.',
      },
      'reps': {
        'title': 'Repetări',
        'message':
          'Introdu numărul exact de repetări pe care le-ai efectuat. Analiza va evalua doar numărul specific de repetări pe care îl introduci, și acest lucru nu poate fi schimbat mai târziu.',
      },
    },
    'homeFirstLiftCard': {
      'title': 'Atinge aici pentru analiza ta',
      'description':
        'Liftul tău apare aici cu analiza aferentă. Atinge pentru detalii sau glisează pentru a șterge.',
    },
    ...
    'libraryScreen': {
      ...
      'description':
        'Aici vezi toate lifturile. Comută între Toate și Favorite. Sortează, filtrează și caută!\n\nAtinge un lift pentru detalii, glisează pentru a șterge.',
    },
    'homePerformanceIcon': {
    ...
    'completionModal': {
      ...
      'message':
        'Ești pregătit să folosești Form AI. Revino zilnic pentru a-ți menține seria și consecvența.\n\nPoți reda oricând acest tutorial din setări.',
    },
  },
  'upload': {
    'permissionRequired': 'Permisiune necesară',
    ...
    'mediaPermissionDetailedDescription':
      'Form AI accesează biblioteca ta de fotografii pentru ca tu să poți încărca videoclipuri pentru analiză, să salvezi videoclipuri înregistrate în aplicație în biblioteca ta de fotografii, să cauți videoclipuri analizate anterior și să previ cărcarea de videoclipuri duplicate.',
    'allow': 'Permite',
    'dontAllow': 'Nu permite',
    ...
    'duplicateVideoProcessingMessage':
      'Acest video este în curs de procesare. Te rugăm să alegi altul.',
